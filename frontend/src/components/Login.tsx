    ...
    <div className="max-w-sm mx-auto p-4 border border-slate-700 rounded-xl">
      ...
      <div className="grid gap-2">
        ...
        <div className="flex gap-2">
          <button onClick={()=>send('login')} className="px-3 py-2 rounded bg-indigo-600">Entrar</button>
          <button onClick={()=>send('register')} className="px-3 py-2 rounded border border-slate-600">Crear cuenta</button>
        </div>
