...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('c5929461-d5b0-4bf7-8785-1c8cdfa11b18','11111111-1111-1111-1111-111111111201','¿Cuál es la forma política del Estado español?','Art. 1','EASY') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('6e6751eb-b673-4322-a876-606ac6ccb62f','11111111-1111-1111-1111-111111111201','¿Dónde reside la soberanía nacional según la Constitución?','Art. 1','EASY') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('2caf3af5-e03b-4e6e-b321-7344ffb08821','11111111-1111-1111-1111-111111111201','¿Qué principio reconoce el artículo 2 de la Constitución?','Art. 2','EASY') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('00b2a5de-b7e6-4d2d-a749-f64619a53a5f','11111111-1111-1111-1111-111111111201','¿Cuál es la lengua oficial del Estado?','Art. 3','EASY') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('d4671873-1193-4688-a9ce-e1b62aea2c80','11111111-1111-1111-1111-111111111201','¿Cuál es la bandera de España según la Constitución?','Art. 4','EASY') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('122e4eff-e3be-4565-b07d-1cf847fefa6c','11111111-1111-1111-1111-111111111201','¿Qué función atribuye la Constitución a los partidos políticos?','Art. 6','EASY') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('30882d58-e62f-448c-96c7-d88cdb12b9ef','11111111-1111-1111-1111-111111111201','¿Qué organizaciones defienden los intereses económicos y sociales según la Constitución?','Art. 7','EASY') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('cd538984-661a-4aea-a0cf-dbde0e846107','11111111-1111-1111-1111-111111111201','¿Cuál es la misión de las Fuerzas Armadas?','Art. 8','EASY') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('5f3f39d5-e352-4f82-909c-ae03b04628ac','11111111-1111-1111-1111-111111111201','¿Qué derecho reconoce el artículo 14?','Art. 14','MEDIUM') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('dabb1f80-83ac-446e-b253-045ffceff713','11111111-1111-1111-1111-111111111202','¿Qué derecho reconoce el artículo 15?','Art. 15','MEDIUM') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('9ab19f20-9471-4b5d-a5a2-30aaafc31380','11111111-1111-1111-1111-111111111202','¿Qué establece el artículo 16 sobre la confesión del Estado?','Art. 16','MEDIUM') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('06b79247-0728-4171-a35e-5d0f2932d6fc','11111111-1111-1111-1111-111111111202','¿Qué derecho protege el artículo 18?','Art. 18','MEDIUM') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('2727fa2a-98a8-4116-adc0-ab47c91425be','11111111-1111-1111-1111-111111111202','¿Qué derecho regula el artículo 20?','Art. 20','MEDIUM') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('f8eb8aec-f85f-4e31-addd-75e85deeace3','11111111-1111-1111-1111-111111111202','¿Qué derecho recoge el artículo 21?','Art. 21','MEDIUM') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('b296e6a5-36df-4c96-8807-8925cf3e678f','11111111-1111-1111-1111-111111111202','¿Qué derecho regula el artículo 22?','Art. 22','MEDIUM') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('6c941b2f-b3cc-44f1-a148-4db75e2b1f4a','11111111-1111-1111-1111-111111111202','¿Qué derecho reconoce el artículo 23?','Art. 23','MEDIUM') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('c7bd91fd-9785-4b31-b930-2bf8becc3a6f','11111111-1111-1111-1111-111111111202','¿Qué garantiza el artículo 24?','Art. 24','HARD') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('a2b3b55e-2805-4fc0-94f1-a2c5d9c31741','11111111-1111-1111-1111-111111111202','¿Qué reconoce el artículo 27?','Art. 27','HARD') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('7fc81d3d-0040-448e-89c6-f8be5905136e','11111111-1111-1111-1111-111111111202','¿Qué establece el artículo 30?','Art. 30','HARD') ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('46e7c0be-5f5e-400f-a0e0-952122d42c2e','11111111-1111-1111-1111-111111111202','¿Qué reconoce el artículo 35?','Art. 35','HARD') ON CONFLICT DO NOTHING;
