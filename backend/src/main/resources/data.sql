...
INSERT INTO users(id, email, password_hash, role, first_name, last_name, occupation) VALUES
  ...
  ('33333333-3333-3333-3333-333333333333','student@akdemya.com','$2b$05$ZQaA2oiJaXCVFN540AU1du73.MrLGBMoacIKQ/.IJaDc2samK3eum','STUDENT',NULL,NULL,NULL)
ON CONFLICT DO NOTHING;
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('c5929461-d5b0-4bf7-8785-1c8cdfa11b18','11111111-1111-1111-1111-111111111112','¿Cuál es la forma política del Estado español?','Art. 1','EASY');
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('6e6751eb-b673-4322-a876-606ac6ccb62f','11111111-1111-1111-1111-111111111112','¿Dónde reside la soberanía nacional según la Constitución?','Art. 1','EASY');
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('2caf3af5-e03b-4e6e-b321-7344ffb08821','11111111-1111-1111-1111-111111111112','¿Qué principio reconoce el artículo 2 de la Constitución?','Art. 2','EASY');
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('00b2a5de-b7e6-4d2d-a749-f64619a53a5f','11111111-1111-1111-1111-111111111112','¿Cuál es la lengua oficial del Estado?','Art. 3','EASY');
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('d4671873-1193-4688-a9ce-e1b62aea2c80','11111111-1111-1111-1111-111111111112','¿Cuál es la bandera de España según la Constitución?','Art. 4','EASY');
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('122e4eff-e3be-4565-b07d-1cf847fefa6c','11111111-1111-1111-1111-111111111112','¿Qué función atribuye la Constitución a los partidos políticos?','Art. 6','EASY');
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('30882d58-e62f-448c-96c7-d88cdb12b9ef','11111111-1111-1111-1111-111111111112','¿Qué organizaciones defienden los intereses económicos y sociales según la Constitución?','Art. 7','EASY');
...
INSERT INTO questions(id, unit_id, text, explanation, difficulty) VALUES ('cd538984-661a-4aea-a0cf-dbde0e846107','11111111-1111-1111-1111-111111111112','¿Cuál es la misión de las Fuerzas Armadas?','Art. 8','EASY');
